...
if(!dir.exists('figures/P04-periodicity')) {
    dir.create('figures/P04-periodicity')
}
...
knitr::opts_chunk$set(warning = FALSE,
                      ...
                      fig.retina = 2,
                      fig.align = 'center',
                      fig.path = 'figures/P04-periodicity/')
```

----

This script includes analyses on whether there is evidence of circadian variation in body temperature in pangolins. The analysis is for one animal (**P04**) and includes chronograms, actograms, periodgrams, and autocorrelation.
...
data <- read_rds('data-cleaned/pangolin/P04-cleaned.rds')
...
# Convery month to an ordered factor
actograms %<>%
...
actograms %<>%
    ...
    mutate(data_binned = map(.x = data,
                             ~ .x %>% 
                                 ...
                                 summarise(temp_binned = mean(body_temp, 
                                                              na.rm = TRUE)) %>% 
...
**Please note that the sequence of months is September 2015 (orange) through to January 2018 (pink).**
...
**Please note that the sequence of months is September 2015 through to January 2018.**
