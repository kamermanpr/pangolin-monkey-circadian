...
if(!dir.exists('figures/M04-periodicity')) {
    dir.create('figures/M04-periodicity')
}
...
knitr::opts_chunk$set(warning = FALSE,
                      ...
                      fig.retina = 2,
                      fig.align = 'center',
                      fig.path = 'figures/M04-periodicity/')
```

----

This script includes analyses on whether there is evidence of circadian variation in body temperature in vervet monkeys. The analysis is for one animal [**Ringo (M04)**] and includes chronograms, actograms, periodgrams, and autocorrelation.
...
data <- read_rds('data-cleaned/monkey/M04-cleaned.rds')
```
