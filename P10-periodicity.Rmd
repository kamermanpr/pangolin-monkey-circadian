...
if(!dir.exists('figures/P10-periodicity')) {
    dir.create('figures/P10-periodicity')
}
...
knitr::opts_chunk$set(warning = FALSE,
                      ...
                      fig.retina = 2,
                      fig.align = 'center',
                      fig.path = 'figures/P10-periodicity/')
```

----

This script includes analyses on whether there is evidence of circadian variation in body temperature in pangolins. The analysis is for one animal (**P10**) and includes chronograms, actograms, periodgrams, and autocorrelation.
...
data <- read_rds('data-cleaned/pangolin/P10-cleaned.rds')
...
**Please note that the sequence of months is June 2017 (orange) through to January 2018 (blue).**
...
**Please note that the sequence of months is June 2017 through to January 2018.**
