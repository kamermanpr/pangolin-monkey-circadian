...
if(!dir.exists('figures/M03-periodicity')) {
    dir.create('figures/M03-periodicity')
}
...
knitr::opts_chunk$set(warning = FALSE,
                      ...
                      fig.retina = 2,
                      fig.align = 'center',
                      fig.path = 'figures/M03-periodicity/')
```

----

This script includes analyses on whether there is evidence of circadian variation in body temperature in vervet monkeys. The analysis is for one animal [**Dante (M03)**] and includes chronograms, actograms, periodgrams, and autocorrelation.
...
data <- read_rds('data-cleaned/monkey/M03-cleaned.rds')
```
