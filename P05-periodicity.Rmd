...
if(!dir.exists('figures/P05-periodicity')) {
    dir.create('figures/P05-periodicity')
}
...
knitr::opts_chunk$set(warning = FALSE,
                      ...
                      fig.retina = 2,
                      fig.align = 'center',
                      fig.path = 'figures/P05-periodicity/')
```

----

This script includes analyses on whether there is evidence of circadian variation in body temperature in pangolins. The analysis is for one animal (**P05**) and includes chronograms, actograms, periodgrams, and autocorrelation.
...
data <- read_rds('data-cleaned/pangolin/P05-cleaned.rds')
...
**Please note that the sequence of months is September 2015 (orange) through to March 2016 (blue).**
...
**Please note that the sequence of months is September 2015 through to March 2016.**
