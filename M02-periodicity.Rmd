...
if(!dir.exists('figures/M02-periodicity')) {
    dir.create('figures/M02-periodicity')
}
...
knitr::opts_chunk$set(warning = FALSE,
                      ...
                      fig.retina = 2,
                      fig.align = 'center',
                      fig.path = 'figures/M02-periodicity/')
```

----

This script includes analyses on whether there is evidence of circadian variation in body temperature in vervet monkeys. The analysis is for one animal [**Pancho (M02)**] and includes chronograms, actograms, periodgrams, and autocorrelation.
...
data <- read_rds('data-cleaned/monkey/M02-cleaned.rds')
```
