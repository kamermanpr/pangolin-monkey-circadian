...
if(!dir.exists('figures/M05-periodicity')) {
    dir.create('figures/M05-periodicity')
}
...
knitr::opts_chunk$set(warning = FALSE,
                      ...
                      fig.retina = 2,
                      fig.align = 'center',
                      fig.path = 'figures/M05-periodicity/')
```

----

This script includes analyses on whether there is evidence of circadian variation in body temperature in vervet monkeys. The analysis is for one animal [**Cyclops (M05)**] and includes chronograms, actograms, periodgrams, and autocorrelation.
...
data <- read_rds('data-cleaned/monkey/M05-cleaned.rds')
```
